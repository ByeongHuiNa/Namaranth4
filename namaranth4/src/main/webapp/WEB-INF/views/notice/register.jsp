	                  ...
	                  <div class="card-body">
			           <form action="/notice/register" method="POST">
	                       <div class="form-group noticeInput">
                               ...
                               <input type="text" name="noti_title" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="제목" required>
                           ...
                           <div class="form-group" id="noticeContent">
                               ...
                               <textarea class="form-control" name="noti_content" id="exampleFormControlTextarea1" rows="30"></textarea>
                           </div>
	                       <div class="d-flex justify-content-end" id="updateBtn">
			                   <button type="submit" class="btn btn-primary" id="getRegister">등록</button>
	                       </div>
	                    </form>
	                    </div>
	                </div>
